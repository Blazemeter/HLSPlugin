 ...
 */
        ...
        String result = p.extractMediaUrl(res, "280x180", 170129, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
        ...
        result = p.extractMediaUrl(res, "640x360", 1395723, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
        ...
        result = p.extractMediaUrl(res, "640x480", 1395723, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
        expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
