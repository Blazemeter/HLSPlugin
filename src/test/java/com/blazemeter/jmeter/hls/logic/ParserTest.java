...
public class ParserTest {
  ...
  public void testGetBaseUrl() throws Exception {
    ...
    Mockito.when(httpURLConnectionMock.getContentType())
 ...
 */
    ...
    String result = p
        .extractMediaUrl(res, "280x180", 170129, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
    ...
    result = p
        .extractMediaUrl(res, "640x360", 1395723, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
    ...
    result = p.extractMediaUrl(res, "320x180", null, BandwidthOption.MIN, ResolutionOption.CUSTOM);
    ...
    result = p.extractMediaUrl(res, "640x480", null, BandwidthOption.MAX, ResolutionOption.CUSTOM);
    ...
    result = p
        .extractMediaUrl(res, "640x480", 1395723, BandwidthOption.CUSTOM, ResolutionOption.CUSTOM);
    expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "640x360", null, BandwidthOption.MIN, ResolutionOption.CUSTOM);
    expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "640x360", null, BandwidthOption.MAX, ResolutionOption.CUSTOM);
    expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "", 1395723, BandwidthOption.CUSTOM, ResolutionOption.MAX);
    expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "", null, BandwidthOption.MIN, ResolutionOption.MAX);
    expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "", null, BandwidthOption.MAX, ResolutionOption.MAX);
    expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "", 1395723, BandwidthOption.CUSTOM, ResolutionOption.MIN);
    expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
    ...
    result = p.extractMediaUrl(res, "", null, BandwidthOption.MIN, ResolutionOption.MIN);
    ...
    result = p.extractMediaUrl(res, "", null, BandwidthOption.MAX, ResolutionOption.MIN);
    expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
