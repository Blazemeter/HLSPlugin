...
public class HlsSamplerTest {
  ...
  public void testSample() throws Exception {
    ...
    respond3
        .setRequestHeaders("GET  https://pb.tedcdn.com/bumpers/hls/video/in/Thousands-320k_1.ts\n");
    ...
    respond4
        .setRequestHeaders("GET  https://pb.tedcdn.com/bumpers/hls/video/in/Thousands-320k_2.ts\n");
    ...
    respond5
        .setRequestHeaders("GET  https://pb.tedcdn.com/bumpers/hls/video/in/Thousands-320k_3.ts\n");
    ...
    assertEquals(new String(payload1.getBytes(), StandardCharsets.UTF_8),
        new String(result.getResponseData(), StandardCharsets.UTF_8));
    ...
    assertTrue(subresults[0].isSuccessful());
    ...
    assertEquals(new String(payload2.getBytes(), StandardCharsets.UTF_8),
        new String(subresults[0].getResponseData(), StandardCharsets.UTF_8));
    ...
    assertTrue(subsubresults[0].isSuccessful());
    ...
    assertTrue(subsubresults[1].isSuccessful());
    ...
    assertTrue(subsubresults[2].isSuccessful());
