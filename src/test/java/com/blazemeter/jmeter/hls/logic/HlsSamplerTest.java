...
public class HlsSamplerTest {
    ...
    public void testSample() throws Exception {
        ...
        Mockito.when(parserMock.extractMediaUrl(Mockito.any(String.class), Mockito.any(String.class), Mockito.any(Integer.class), Mockito.any(BandwidthOption.class), Mockito.any(ResolutionOption.class)))
        ...
        assertEquals(new String(payload2.getBytes(), StandardCharsets.UTF_8), new String(subresults[0].getResponseData(), StandardCharsets.UTF_8));
