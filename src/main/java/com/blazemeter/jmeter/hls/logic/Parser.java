...
public class Parser implements Serializable {
    ...
    public static final Pattern STREAM_PATTERN = Pattern.compile("(EXT-X-STREAM-INF.*)\\n(.*\\.m3u8.*)");
    ...
    public String extractMediaUrl(String playlistData, String customResolution, Integer customBandwidth, BandwidthOption bwSelected, ResolutionOption resSelected) {
        ...
        while (streamMatcher.find()) {
            ...
            String matched_uri = streamMatcher.group(2);
            if (bwSelected.matches(streamBandwidth, lastMatchedBandwidth, customBandwidth)) {
                lastMatchedBandwidth = streamBandwidth;
                LOG.info("resolution match: {}, {}, {}, {}", streamResolution, lastMatchedResolution, resSelected, customResolution);
